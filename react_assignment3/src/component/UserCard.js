...
import {AiOutlineHeart,AiFillHeart,AiOutlineEdit,AiFillDelete} from "react-icons/ai"


const UserCard = ({item}) => {
    const [like,setlike] = useState(false)
    console.log("curren state", like)
        ...
        <ul class="ant-card-actions">
            <li style={{width: '33.33px'}}>
               <button onClick={handleClick}>
                    {
                      like ? <icon><AiFillHeart size={25} className="text-danger"/></icon>: 
                          <icon>
            ...
            <li>
                <button>
                    {
                        <icon><AiOutlineEdit size={25}/></icon>
                    }
                </button>
            </li>
            <li>
               <button onClick={deleteData}> 
                {
                    <icon><AiFillDelete size={25}/></icon>
                }
               </button>
            </li>
        </ul>
